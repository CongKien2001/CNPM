                ...
                <div class="cart_main">
                    <div class="row">
                                            ...
                                            <tr class="cartList">
                                                <td class="cart_product">
                                                    <div class="cart-items-remove-box cart_body">
                                                        <a href="../cart/delete_cart.php?delete_cart=154" class="cart-items-remove tag-a">x</a>
                                                    </div>
                                                    <div class="cart-items-img cart_body">
                                                        <img src="<?php echo './assets/img/' .  $rowww["anh"]?>" alt="">
                                                    </div>
                                                ...
                                                <td class="total_money_details" style="font-weight: 600; text-align: center;padding-top:17px;"><?php   echo $tamtinh?><sup>đ</sup></td>
                                            </tr>
                        ...
                        <div class="col dt dtt cart_right">
                            ...
                            <div class="tam-tinh">
                                <span>Tạm tính</span>
                                <div class="tam-tinh-money"><?php   echo $tam?><sup>đ</sup></div>
                            </div>
                            <div class="giao-hang">
                            ...
                            <div class="total_money">
                                <div class="total_money-title">
                                    <span>Tổng tiền:<?php   echo $tam+$phigiaohang?><sup>đ</sup></span>
                                </div>
                            </div>
                            <a href="" class="shop_NSX-a ">
